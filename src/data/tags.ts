...
export const bookTags = ['책', '단어장', '공책', '플래너', '기타'] as const;
export const bookWithSubjectTags = ['문제집', '교과서'] as const;
...
export type BookWithSubjectTagTuple = typeof bookWithSubjectTags;
export type BookWithSubjectTag = BookWithSubjectTagTuple[number];

export type TagTuple = NormalTagTuple | MarketTagTuple | BookTagTuple | BookWithSubjectTagTuple;
export type Tag = '태그' | NormalTag | MarketTag | BookTag | BookWithSubjectTag;
